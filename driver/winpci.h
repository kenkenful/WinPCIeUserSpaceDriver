...
#define	IOCTL_WINPCI_GET_SBOBJ									CTL_CODE(FILE_DEVICE_WINPCI, 0x809, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define	IOCTL_WINPCI_READ_CONFIG_SB						CTL_CODE(FILE_DEVICE_WINPCI, 0x80A, METHOD_OUT_DIRECT, FILE_ANY_ACCESS)
#define	IOCTL_WINPCI_WRITE_CONFIG_SB						CTL_CODE(FILE_DEVICE_WINPCI, 0x80B, METHOD_OUT_DIRECT, FILE_ANY_ACCESS)
